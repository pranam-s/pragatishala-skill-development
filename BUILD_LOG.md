...
## 2026-09-13: Publication re-check at final HEAD (AR4)
...
## 2026-09-12: Adversarial review 3 (AR3) remediation
...
## 2026-09-10 → 2026-09-11: backend completion, frontend wiring, revival
...
- Follow-up (same day): added `RouteTitle` (+2 tests, 33 total) so screen
...
- `uv sync` reinstalls the project wheel on each run; that is fine, the

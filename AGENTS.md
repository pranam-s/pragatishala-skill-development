...
This document tracks the progress of the PragatiShala project: standing
...
*   Quality bar (added 2026-09): latest stable toolchains; ≥90% line AND
...
*   **Initial Research:**
    ...
    *   **Comparable platforms:** personalized "Skill DNA" assessments, activity-based
...
*   **AR-027 fix (2026-09-14):** `/healthz` returns only `{"status":"ok"}`
    ...
    only in debug mode.
*   **Publication re-check (2026-09-13):** hostile re-review at
...
*   **Third adversarial review (2026-09-12):** all 11 findings from
...
*   **Frontend:** React 19 + Chakra UI v3 + React Router; typed API client with
    ...
    against the installed v3 library, and it was rebuilt on 2026-09-11.
